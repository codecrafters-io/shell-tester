...
// Patched at copy time: slots 1–2 = env var names; 3–5 = expected argv; 6–7 = expected COMP_LINE / COMP_POINT.
var (
	envLineVar  = "<<RANDOM_1>>"
...
// Full candidate list (PA8); stdout is filtered by prefix match on argv[2] after validation.
var allCandidates = []string{"add", "commit", "push", "checkout"}
