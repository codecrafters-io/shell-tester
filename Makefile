...
build_executables:
	...
	for os in $$oses; do \
		...
		GOOS="$$os" GOARCH="$$arch" go build -ldflags="-X 'main.secretCode=ryanknows'" -o built_executables/signaturer_printer_$${os}_$${arch} ./internal/custom_executable/signature_printer/main.go; \
